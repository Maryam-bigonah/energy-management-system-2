...
class LPGExecutor:
    ...
    def execute_lpg_binaries(self) -> Any:
        ...
        print("subprocess returned: " + str(ret.returncode))
        if ret.returncode != 0:
            raise Exception("Subprocess failed with return code " + str(ret.returncode))
        print("Directory content of " + str(self.calculation_directory) + ":")
        print(glob.glob(str(self.calculation_directory) + "/**/*", recursive=True))
